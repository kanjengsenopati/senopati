...
router.get(
  ...
  wrapAsync(async (req, res) => {
    ...
    const payload = await InventoryDBApi.findAll(req.query, { currentUser });
...
router.get(
  ...
  wrapAsync(async (req, res) => {
    const currentUser = req.currentUser;
    const payload = await InventoryDBApi.findAll(req.query, null, {
      countOnly: true,
      currentUser,
    });
...
router.get(
  '/:id',
  wrapAsync(async (req, res) => {
    const payload = await InventoryDBApi.findBy({ id: req.params.id });
