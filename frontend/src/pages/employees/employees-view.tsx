    ...
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          ...
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Manager</p>

            <p>{employees?.manager?.firstName ?? 'No data'}</p>
          </div>

          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>Salary</p>
            <p>{employees?.salary || 'No data'}</p>
          </div>
