  ...
  return (
    <>
      ...
      <SectionMain>
        ...
        <CardBox>
          <div className={'mb-4'}>
            <p className={'block font-bold mb-2'}>CheckPoint</p>
            <p>{quality_control?.check_point}</p>
          </div>
          ...
          <FormField label='Passed'>
            <SwitchField
              field={{ name: 'passed', value: quality_control?.passed }}
            ...
            {quality_control.check_date ? (
              <DatePicker
                ...
                selected={
                  quality_control.check_date
                    ? new Date(
                        dayjs(quality_control.check_date).format(
                          'YYYY-MM-DD hh:mm',
                        ),
                      )
                    : null
